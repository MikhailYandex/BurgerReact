...
const Footer = () => {
  return (
    <footer className={_.footer}>
      <Container>
        <div className={_.footer__content}>
          <img
          ...
          <address className={_.footer__address}>
            <div className={_.footer__contact}>
              <h2 className={_.footer__title}>Номер для заказа</h2>

              <a className={_.footer__phone} href="tel:+79308333811">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
          ...
          <div className={_.footer__development}>
            <p>© YouMeal, 2023</p>
            <p>
              Design: <a href="#">Anastasia Ilina</a>
            </p>
            <p>
              Developer: <a href="mailto:maksim.leskin@methed.ru">Mikhail Ponomarenko</a>
            </p>
          </div>
        </div>
      </Container>
